...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  listTree: (dirPath) => ipcRenderer.invoke('file:list-tree', dirPath),
  copyFile: (sourcePath) => ipcRenderer.invoke('file:copy', sourcePath),
  ...
  createDir: (parentPath, name) => ipcRenderer.invoke('dir:create', parentPath, name),
